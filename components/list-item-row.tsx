...
export function ListItemRow({
  ...
  return (
    ...
    >
      ...
      >
        {disabled && <Check className="size-3.5" strokeWidth={3} aria-hidden="true" />}
      </button>
      ...
      <input
        ...
        className={cn(
          ...
          disabled && 'text-muted-foreground line-through decoration-foreground/40',
        )}
      />
      ...
      <button
        ...
        title="Delete"
        className="flex size-7 shrink-0 items-center justify-center rounded-full text-muted-foreground transition-all hover:bg-destructive hover:text-background focus-visible:opacity-100 sm:opacity-0 sm:group-hover:opacity-100"
      >
